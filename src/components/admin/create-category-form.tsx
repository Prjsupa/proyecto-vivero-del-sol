...
import { createCategoryAndAssignProducts } from '@/lib/actions';
        ...
        <Dialog open={isDialogOpen} onOpenChange={onDialogChange}>
            ...
            <DialogContent className="sm:max-w-3xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                       Define el nombre de la nueva categoría y selecciona los productos que pertenecerán a ella.
                    </DialogDescription>
                </DialogHeader>
                <form action={formAction} ref={formRef} className="grid gap-4 py-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="newCategoryName" name="newCategoryName" placeholder="Ej: Plantas Aromáticas"/>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-muted-foreground'>Selecciona los productos para mover a esta nueva categoría.</p>
