...
import { addIncomeVoucher } from '@/lib/aux-actions';
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>Crear Nuevo Comprobante de Ingreso</DialogTitle>
                    <DialogDescription>
                ...
                <form action={formAction} ref={formRef} className="grid gap-4 py-4">
                    <div className="space-y-2">
                        ...
                        <Input id="code" name="code" placeholder="Ej: FCA" />
                     ...
                     <div className="space-y-2">
                        ...
                        <Input id="description" name="description" placeholder="Ej: Factura Tipo A" />
