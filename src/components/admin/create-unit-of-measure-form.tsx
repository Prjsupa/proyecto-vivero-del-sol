...
export function CreateUnitOfMeasureForm({ onActionCompleted }: { onActionCompleted: () => void }) {
    const [state, formAction] = useActionState(addUnitOfMeasure, { message: '' });
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <form action={formAction} ref={formRef} className="grid gap-4 py-4">
                    <div className="space-y-2">
                        ...
                        <Input id="code" name="code" placeholder="Ej: UN" />
                     ...
                     <div className="space-y-2">
                        ...
                        <Input id="description" name="description" placeholder="Ej: Unidad" />
