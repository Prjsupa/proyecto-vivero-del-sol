...
import { BatchEditColorForm } from "./batch-edit-color-form";

export function ColorBatchActions({ selectedProductIds, onActionCompleted }: { selectedProductIds: string[], onActionCompleted: () => void }) {
