...
import { updateProductDescriptionText } from '@/lib/actions';
...
export function EditProductDescriptionForm({ description, onDescriptionUpdated }: { description: string, onDescriptionUpdated: () => void }) {
    const [state, formAction] = useActionState(updateProductDescriptionText, { message: '' });
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Modifica el texto de la descripción. Esto se actualizará en todos los productos que la utilicen.
                    </DialogDescription>
                </DialogHeader>
