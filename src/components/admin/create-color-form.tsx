...
import { createColorAndAssignProducts } from '@/lib/actions';
        ...
        <Dialog open={isDialogOpen} onOpenChange={onDialogChange}>
            ...
            <DialogContent className="sm:max-w-3xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                       Define el nombre del nuevo color y selecciona los productos que lo tendrán.
                    </DialogDescription>
                </DialogHeader>
                <form action={formAction} ref={formRef} className="grid gap-4 py-4">
                     <input type="hidden" name="productIds" value={selectedProductIds.join(',')} />
                    <div className="space-y-2">
                        <Label htmlFor="newColorName">Nombre del Nuevo Color</Label>
                        <Input id="newColorName" name="newColorName" placeholder="Ej: Azul Marino"/>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-muted-foreground'>Selecciona los productos para asignarles este nuevo color.</p>
