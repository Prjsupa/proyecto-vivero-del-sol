...
import { updateCategoryName } from '@/lib/actions';
...
export function EditCategoryForm({ categoryName, allCategories, onCategoryUpdated }: { categoryName: string, allCategories: string[], onCategoryUpdated: () => void }) {
    const [state, formAction] = useActionState(updateCategoryName, { message: '' });
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Renombra la categoría '{categoryName}'. Esto actualizará todos los productos asociados.
                    </DialogDescription>
                </DialogHeader>
