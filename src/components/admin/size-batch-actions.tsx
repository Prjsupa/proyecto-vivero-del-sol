...
import { BatchEditSizeForm } from "./batch-edit-size-form";

export function SizeBatchActions({ selectedProductIds, onActionCompleted }: { selectedProductIds: string[], onActionCompleted: () => void }) {
