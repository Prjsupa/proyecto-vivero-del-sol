...
export function BatchEditServiceCategoryForm({ serviceIds, allCategories, onActionCompleted }: { serviceIds: string[], allCategories: string[], onActionCompleted: () => void }) {
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>Mover Servicios de Categoría</DialogTitle>
                    <DialogDescription>
                        Mueve los {serviceIds.length} servicios seleccionados a una nueva categoría.
                    </DialogDescription>
                </DialogHeader>
