...
import { BatchEditServiceDescriptionForm } from "./batch-edit-service-description-form";

export function ServiceDescriptionBatchActions({ selectedServiceIds, onActionCompleted }: { selectedServiceIds: string[], onActionCompleted: () => void }) {
    ...
    return (
        <div className="p-4 bg-muted/50 rounded-lg flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
                 <BatchEditServiceDescriptionForm
