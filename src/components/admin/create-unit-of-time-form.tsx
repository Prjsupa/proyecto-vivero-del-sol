...
import { addUnitOfTime } from '@/lib/aux-actions';
...
export function CreateUnitOfTimeForm({ onActionCompleted }: { onActionCompleted: () => void }) {
    const [state, formAction] = useActionState(addUnitOfTime, { message: '' });
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>Crear Nueva Unidad de Tiempo</DialogTitle>
                    <DialogDescription>
                ...
                <form action={formAction} ref={formRef} className="grid gap-4 py-4">
                    <div className="space-y-2">
                        ...
                        <Input id="code" name="code" placeholder="Ej: MES" />
                     ...
                     <div className="space-y-2">
                        ...
                        <Input id="description" name="description" placeholder="Ej: Mes" />
