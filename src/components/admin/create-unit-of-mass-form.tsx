...
import { addUnitOfMass } from '@/lib/aux-actions';
...
export function CreateUnitOfMassForm({ onActionCompleted }: { onActionCompleted: () => void }) {
    const [state, formAction] = useActionState(addUnitOfMass, { message: '' });
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>Crear Nueva Unidad de Masa</DialogTitle>
                    <DialogDescription>
                ...
                <form action={formAction} ref={formRef} className="grid gap-4 py-4">
                    <div className="space-y-2">
                        ...
                        <Input id="code" name="code" placeholder="Ej: KG" />
                     ...
                     <div className="space-y-2">
                        ...
                        <Input id="description" name="description" placeholder="Ej: Kilogramo" />
