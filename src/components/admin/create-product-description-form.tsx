...
import { createProductDescriptionAndAssign } from '@/lib/actions';
...
export function CreateProductDescriptionForm({ allProducts, onActionCompleted }: { allProducts: Product[], onActionCompleted?: () => void }) {
    const [state, formAction] = useActionState(createProductDescriptionAndAssign, { message: '' });
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={onDialogChange}>
            ...
            <DialogContent className="sm:max-w-3xl">
                <DialogHeader>
                    <DialogTitle>Crear Nueva Descripción de Producto</DialogTitle>
                    <DialogDescription>
                       Define la nueva descripción y selecciona los productos a los que se asignará.
                    </DialogDescription>
                </DialogHeader>
                <form action={formAction} ref={formRef} className="grid gap-4 py-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea id="newDescription" name="newDescription" placeholder="Ej: Ideal para interiores con poca luz..."/>
                    ...
                    <div>
                        <Label>Asignar Productos (Opcional)</Label>
                        <p className='text-sm text-muted-foreground'>Selecciona los productos para asignarles esta nueva descripción.</p>
